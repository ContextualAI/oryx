...
![User message styling example](/imgs/styling-user-message.png)
...
![Agent message styling example](/imgs/styling-agent-message.png)
...
![Input bar styling example](/imgs/styling-input-bar.png)
...
Want to try it yourself? Explore our [basic usage example](/basic-usage-example) — all snippets above come straight from it, so you can dive in right away.
